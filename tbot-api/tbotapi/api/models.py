...
class Account(models.Model):
    ...
    exchange = models.CharField(max_length=250, choices=Exchange.choices)
...
class Market(models.Model):
    ...
    limits_cost_min = models.DecimalField(max_digits=30, decimal_places=8)
    limits_cost_max = models.DecimalField(max_digits=30, decimal_places=8)
...
class OrderErrorLog(models.Model):
    ...
    order = models.ForeignKey(
        "Order", related_name="error_log", on_delete=models.CASCADE
    )
...
class TAStrategy(models.Model):
    name = models.CharField(max_length=200)
    account = models.ForeignKey(Account, on_delete=models.CASCADE)
    trade_unit = models.DecimalField(max_digits=30, decimal_places=8)
    confidence = models.IntegerField()
    iniital_currency = models.ForeignKey(Currency, on_delete=models.CASCADE)

    def __str__(self):
        return f"{self.name}"


class TAExecution(models.Model):
    strategy = models.ForeignKey(TAStrategy, on_delete=models.CASCADE)
    timestamp = models.DateTimeField()
    initial_currency = models.ForeignKey(Currency, on_delete=models.CASCADE)
    p_order_1 = models.ForeignKey('api.Order', on_delete=models.CASCADE, 
            related_name='p_trade_1')
    p_order_2 = models.ForeignKey('api.Order', on_delete=models.CASCADE,
            related_name='p_trade_2')
    p_order_3 = models.ForeignKey('api.Order', on_delete=models.CASCADE,
            related_name='p_trade_3')
    order_1 = models.ForeignKey('api.Order', on_delete=models.CASCADE, 
            related_name='trade_1')
    order_2 = models.ForeignKey('api.Order', on_delete=models.CASCADE,
            related_name='trade_2')
    order_3 = models.ForeignKey('api.Order', on_delete=models.CASCADE,
            related_name='trade_3')


class TAAnalysis(models.Model):
    execution = models.ForeignKey(TAExecution, on_delete=models.CASCADE)
    full_sec_d = models.DecimalField(max_digits=30, decimal_places=2)
    payoff = models.DecimalField(max_digits=30, decimal_places=8) 
    o1_price_d = models.DecimalField(max_digits=30, decimal_places=8)
    o2_price_d = models.DecimalField(max_digits=30, decimal_places=8)
    o3_price_d = models.DecimalField(max_digits=30, decimal_places=8)
    o1_amount_d = models.DecimalField(max_digits=30, decimal_places=8)
    o2_amount_d = models.DecimalField(max_digits=30, decimal_places=8)
    o3_amount_d = models.DecimalField(max_digits=30, decimal_places=8) 
    o1_o2_sec_d = models.DecimalField(max_digits=30, decimal_places=8)
    o2_o3_sec_d = models.DecimalField(max_digits=30, decimal_places=8)
    o1_o3_sec_d = models.DecimalField(max_digits=30, decimal_places=8)
    start_sec_d = models.DecimalField(max_digits=30, decimal_places=8)
...
class Trade(models.Model):
    ...
    class TakerMaker(models.TextChoices):
        MAKER = "maker"
        TAKER = "taker"

    order = models.ForeignKey(Order, related_name="trade_order", 
            on_delete=models.CASCADE)
    trade_id = models.CharField(max_length=255, unique=True)
    timestamp = models.DateTimeField()
    taker_maker = models.CharField(max_length=8, choices=TakerMaker.choices)
